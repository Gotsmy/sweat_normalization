...
import pandas as pd
import sys
from size_effect_normalization import extended_model as em
from size_effect_normalization import synthetic_data_generation as sdg
from size_effect_normalization import normalization as norm
import pickle
import time
...
if __name__ == "__main__":
    ...
    ## END INPUT PARAMETERS ##
            ...
            for n_replicate in range(n_replicates):
                ...
                # here it is possible to change the mode of synthetic data generations:
